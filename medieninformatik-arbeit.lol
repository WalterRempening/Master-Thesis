...
\contentsline {lstlisting}{\numberline {4.6}Sculpture update function}{36}{lstlisting.4.6}
\contentsline {lstlisting}{\numberline {4.7}Passport OAuth authentication implementation}{37}{lstlisting.4.7}
\contentsline {lstlisting}{\numberline {4.8}Withings API query and response example}{38}{lstlisting.4.8}
\contentsline {lstlisting}{\numberline {B.1}WCVaseGeometry.js}{72}{lstlisting.B.1}
