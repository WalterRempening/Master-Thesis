var s_tc_Wired=new TagContainer('Wired');
...
s_tc_Wired.cl=[{p:[{t:'s',u:'//js.revsci.net/gateway/gw.js?csid=F09828&auto=t&bpid=condenast'}]},
{p:[{t:'c',c:'var _comscore = _comscore || [];\n_comscore.push({ c1: "2", c2: "6035094" });\n(function() {\nvar s = document.createElement("script"), el = \ndocument.getElementsByTagName("script")[0]; s.async = true;\ns.src = (document.location.protocol == "https:" ? "https://sb" : "http://b") + \n".scorecardresearch.com/beacon.js";\nel.parentNode.insertBefore(s, el);\n})();'}]},
{p:[{t:'c',c:'var gptAdsCount = -2;  // Indicates googletag not defined soon enough to count the ads\nvar gptAdsList = "";\nvar gptEmAdsCount = 0;\nvar gpt1by1Count = 0;\nvar gptEmAdsList = "";\nvar emptyAd;\nvar domLoaded = false;\n\nfunction setDomLoaded() {\n    domLoaded = true;\n}\nwindow.onload = setDomLoaded();\n\nfunction incrementAdCounter(event) {\n    /*\n    if (event.size[0] === 1 && event.size[1] === 1) {\n        gpt1by1Count++;\n        console.log("1x1: " + event.slot.getSlotId().d);\n    } else \n    */\n    if (event.isEmpty) {\n//        console.log("Empty Ad: " + event.slot.getSlotId().d);\n        gptEmAdsCount++;\n        gptEmAdsList += event.slot.getSlotId().d + " ";\n        emptyAd = event;\n    } else {\n        gptAdsCount++;\n        gptAdsList += (event.size[0] + "x" + event.size[1] + " "); \n//        console.log("Incrementing ADS: " + gptAdsList);\n    }\n}\n\n\nfunction abTrack(to) {\n    var xmlHttp = null;\n    var numAds = -1;\n    var noads = "ads";\n    \n    if ((typeof CN !== \'undefined\') && \n        (typeof CN.dart !== \'undefined\') && \n        (typeof CN.dart.getGPTAds() !== \'undefined\') &&\n        (CN.dart.getGPTAdsRenderStatus() === true ) ) {\n            numAds = gptAdsCount;\n    } else {\n        noads = "no_ads";\n    }\n\n    var description = \'\' + numAds + \' ads (\' + gptAdsList + \'), \'\n        + gptEmAdsCount + \' emtyads (\' + gptEmAdsList + \'), \'\n        + \'domLoaded: \' + domLoaded + \', \'\n        + \'userAgent: \' + navigator.userAgent;\n    var eventUrl = \'http://event.wired.com/images/event.gif?e0_sc=WIR&e0_ec=abandoned&e0_env=PROD&e0_id=\' + to + \'secs_\' +noads + \'&e0_ct=na&e0_url=\' + encodeURIComponent(location.href) + \'&e0_tit=\' + encodeURIComponent(description) + \'&e0_pd=na&e0_sctn=na&e0_imgurl=na\';\n  //  console.log(description);\n\n    xmlHttp = new XMLHttpRequest();\n    xmlHttp.open( "GET", eventUrl, false );\n    xmlHttp.send( null );\n    return;\n}\n\nif (typeof googletag !== \'undefined\') {\n//    console.log("Google Tag Defined!");\n    googletag.pubads().addEventListener(\'slotRenderEnded\', incrementAdCounter);\n    gptAdsCount = 0;\n    var abto = Math.floor(Math.random() * (21 - 0)) + 0 ;\n    setTimeout(\'abTrack(\'+abto+\');\', abto * 1000);\n//    console.log("Ads timer group: " + abto + " seconds");\n} else {\n//    console.log("Ads timer group: Undefined");\n\n}'}]}];
s_tc_Wired.cr();